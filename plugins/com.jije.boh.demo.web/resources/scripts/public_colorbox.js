...
(function()
{
    ...
    colorbox.exec = function(param)
    {
        ...
        if (html.length != 0) 
        {
            ...
            if (!colorbox.floor) 
            {
                ...
                //core
                $("#b-main-content").append(colorbox.floor);
                $("#b-main-content").append(colorbox.border);
                $("#b-main-content").append(colorbox.title);
                $("#b-main-content").append(colorbox.content);
            }
    ...
    colorbox.load = function(move)
    {
        ...
        //弹出层移动
        $('#colorBox_title').draggable("enable");
        $('#colorBox_title').draggable(
        {
            onStartDrag: function(e)
            {
                var coord = window._$.coord($("#colorBox_title")[0]);
				$("#colorBox_border").css(
				{
					top:coord.top - 10,
					left:coord.left - 10
				});
				$("#colorBox_content").css(
				{
					top:coord.top + 30,
					left:coord.left + 10
				});					 
    ...
    {
        $("#colorBox_floor,#colorBox_border").css(
        {
            opacity: 0.3
        });
        if (!isMove) 
