...
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>
		...
		<script type="text/javascript" src="/resources/scripts/page_colorbox.js"></script>
    </head>
    <body>
        <div class="b-top">
		...
		<div  class="b-mian-content">
			<div class="b-public-load"></div>	
		</div>
		<script type="text/javascript" src="/resources/scripts/index.js" charset="utf-8"></script>
    </body>
</html>
